...
func TestSignup(t *testing.T) {
	...
	// Act
	actual, err := userService.create(username, email, fullName, accountKey, cred1, cred1, nil)
...
func TestSignup_AlreadyExists(t *testing.T) {
	...
	// Act
	_, err = userService.create("dev1", "dev1@testing.com", "Developer Uno", key, cred1, cred1, nil)
...
func TestSignup_InvalidArgument(t *testing.T) {
	...
	// Act
	_, err = userService.create("invalidname$#@%%", "dev1@testing.com", "Developer Uno", key, cred1, cred1, nil)
