...
type ServiceService interface {
	...
	Create(path string, description string, credential RSACredential) (*api.Service, error)
...
// Create creates a new service account for the given repo.
func (s serviceService) Create(path string, description string, credential RSACredential) (*api.Service, error) {
